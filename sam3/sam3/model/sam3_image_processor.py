...
class Sam3Processor:
    ...
    def set_image(self, image, state=None):
        ...
        state["backbone_out"]["support_info"] = {'use': False,'store': False}
        return state
    ...
    def reset_all_prompts(self, state: Dict):
        ...
        keys_to_del = ["geometric_prompt", "boxes", "masks", "masks_logits", "scores","semantic_mask", "semantic_mask_logits"]
    ...
    def _forward_grounding(self, state: Dict):
        outputs = self.model.forward_grounding(
            ...
            find_target=None,
            support_info= state["backbone_out"]["support_info"]
        ...
        state["semantic_mask_logits"] = out_semantic_masks
        state["semantic_mask"] = out_semantic_masks > 0.5
        state["boxes"] = boxes
        state["scores"] = out_probs
        state['presence_score'] = presence_score
        return state
