...
# 按预估运行时间均衡分配（avg_per_sample × pairs，greedy bin-packing）
# 注：recode-waste 单独占 GPU 0（18.87h），其余 GPU 约 9.5h
#
# GPU 0: ~18.87h (1 subset)  — recode-waste 是极端大子集
# GPU 1:  ~9.49h (5 subsets)
# GPU 2:  ~9.57h (4 subsets)
# GPU 3:  ~9.57h (4 subsets)
# GPU 4:  ~9.59h (6 subsets)
#
# avg per sample 数据来源: results/vqa-val/*/inference.log
...
echo "============================================"
echo " Parallel Run (time-balanced) - $(date)"
echo " Split:   $SPLIT"
echo " GPUs:    ${GPUS[*]}"
echo " Logs:    $LOG_DIR"
echo "============================================"
