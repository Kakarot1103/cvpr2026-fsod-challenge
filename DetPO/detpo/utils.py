...
def load_qwen_model(model_name, server_url="http://localhost:8000/v1", served_model_name=None):
    """
    ...
    client.model_name = served_model_name if served_model_name else "Qwen/" + model_name
    ...
    for class_name in class_name_list:
        if class_name in dataset_instructions_json:
            ...
            if matched_key:
                ...
                print(f"Warning: Class name '{class_name}' not found in dataset instructions JSON keys, skipping.")
                continue
